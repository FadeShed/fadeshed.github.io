...
## Different authors. The same files.
summary: Direct writing, a steered agent or an autonomous agent: three alternatives, not three required steps.

<div class="pv-workflow-image"><img class="pv-diagram-desktop" src="img/concepts/authoring-workflow.svg" alt="Direct writing, a steered agent or an autonomous agent: three alternatives, not three required steps." loading="lazy"><img class="pv-diagram-mobile" src="img/concepts/authoring-workflow-mobile.svg" alt="Direct writing, a steered agent or an autonomous agent: three alternatives, not three required steps." loading="lazy"></div>
