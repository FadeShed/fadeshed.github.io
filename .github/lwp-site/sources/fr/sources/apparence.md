...
## Un même article. Trois identités.
summary: Comparez un point de départ sobre, une documentation structurée et un carnet de terrain.
...
<!-- lwp:slide -->
slug: composer
## Un kit peut réunir plusieurs savoir-faire.
summary: Field Notes assemble un cadre, une signature et un thème en un kit autonome.

Un designer peut apporter la mise en page ; un autre, les marques ; un troisième, la typographie et les couleurs. Le kit composé contient les ressources sélectionnées : ses destinataires n’ont pas besoin de retrouver les kits sources.

<div class="lwp-web-actions"><a href="concepts/field-notes/first-page.html#travels-with-the-page">Explorer Field Notes →</a><a href="downloads/identity-examples.zip">Télécharger les sources des trois exemples ↓</a></div>
...
![Trois couvertures avec les thèmes Lava, Terminal et Pop Lemon.](img/themes-featured.png)

<div class="lwp-web-actions"><a class="lwp-web-button" href="themes.html">Explorer la galerie interactive ↗</a></div>

Ouvrez **Apparence** dans le menu du lecteur (ou appuyez sur **C**) pour essayer les apparences publiées, dont les thèmes **Encre & citron** et **Papier & olive** du site.
