...
<!-- lwp:slide -->
slug: serie
kicker: ORGANISER UNE COLLECTION
## Un article. Plusieurs parcours.
summary: La série choisit les articles, leur ordre et la manière de les présenter dans son index.

Un même texte de référence peut servir à un dossier court et à une collection plus vaste. L’organisation de vos sources détermine cette réutilisation ; reconstruisez les séries concernées après une modification. Il ne s’agit pas d’un service de synchronisation automatique.

Gardez le projet source pour la rédaction. Publiez le dossier de sortie pour les lecteurs.
